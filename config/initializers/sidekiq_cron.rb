...
if Rails.env.production?
	...
	Sidekiq::Cron::Job.create(name: 'Leafly Dispensary 1', cron: '0 */2 * * *', class: 'LeaflyDispensaryWorker1')
	Sidekiq::Cron::Job.create(name: 'Leafly Dispensary 2', cron: '0 */2 * * *', class: 'LeaflyDispensaryWorker2')
	Sidekiq::Cron::Job.create(name: 'Leafly Dispensary 3', cron: '0 */2 * * *', class: 'LeaflyDispensaryWorker3')
	Sidekiq::Cron::Job.create(name: 'Leafly Dispensary 4', cron: '0 */2 * * *', class: 'LeaflyDispensaryWorker4')
end