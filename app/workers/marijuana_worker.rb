  ...
  def perform()
    ...
    def scrapMarijuana()
        ...
        begin
        	...
        	if contents["articles"] != nil && contents["articles"].size > 0
	        	...
	        	ScraperError.email('Marijuana.com News', 'No Articles were returned').deliver	
	        end
        
        rescue => ex
        	ScraperError.email('Marijuana.com News', ex.message).deliver
		end
    end
    ...
    def addArticles(articles)
        ...
        articles.each do |article|
        	...
        	unless article.save
        		ScraperError.email('Marijuana.Com News', 
